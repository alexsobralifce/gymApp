...
export class AuthService {
    ...
    static _jwtSign = null;
    static setJwtSigner(fn) {
     ...
     */
    static async login(input, jwtSign) {
        ...
        const refreshToken = jwtSign({ sub: usuario.id }, { secret: env.JWT_REFRESH_SECRET, expiresIn: env.JWT_REFRESH_EXPIRES_IN });
     ...
     */
    static async refresh(refreshToken, jwtVerify, jwtSign) {
        let payload;
        try {
