      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-surface-card border border-surface-input p-6 shadow-2xl space-y-5 animate-modal-pop">
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            className="w-full flex items-center gap-3.5 p-3.5 rounded-xl border border-surface-input bg-surface hover:border-pink-500/50 hover:bg-pink-500/5 transition-all cursor-pointer text-left group"
          >
          ...
          <button
            ...
            disabled={gerando || publicandoIg}
            className="w-full flex items-center gap-3.5 p-3.5 rounded-xl border border-surface-input bg-surface hover:border-purple-500/50 hover:bg-purple-500/5 transition-all cursor-pointer text-left group"
          >
          ...
          <button
            ...
            disabled={gerando || publicandoIg}
            className="w-full flex items-center gap-3.5 p-3.5 rounded-xl border border-surface-input bg-surface hover:border-blue-500/50 hover:bg-blue-500/5 transition-all cursor-pointer text-left group"
          >
