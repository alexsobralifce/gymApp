    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-surface-input p-3 space-y-1">
        ...
        >
          ...
          <span>Tema: {theme === 'lime' ? 'Lima & Navy' : theme === 'red' ? 'Vermelho & Preto' : 'Violeta & Preto'}</span>
        </button>
        ...
        {!hideNav && (
          <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-surface-input glass px-4 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={toggleTheme}
                title={`Tema atual: ${theme === 'lime' ? 'Verde Lima & Navy' : theme === 'red' ? 'Vermelho & Preto' : 'Violeta & Preto'}. Clique para alterar.`}
              ...
              >
                ...
                <span className="hidden sm:inline">{theme === 'lime' ? 'Lima & Navy' : theme === 'red' ? 'Vermelho' : 'Violeta'}</span>
              </button>
