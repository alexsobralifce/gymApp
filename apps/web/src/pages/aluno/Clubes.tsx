        ...
        {leaderboard.length === 0 ? (
          ...
          <div className="rounded-2xl bg-surface-card border border-surface-input overflow-hidden">
            {leaderboard.map((entry, i) => {
              ...
              return (
                <div key={entry.alunoId} className="flex items-center gap-3 px-4 py-3 border-b border-surface-input last:border-0 hover:bg-white/5 transition-colors">
                  ...
                  <span className="text-sm font-bold text-accent">{entry.xpSemana} XP</span>
                </div>
              )
            })}
          </div>
