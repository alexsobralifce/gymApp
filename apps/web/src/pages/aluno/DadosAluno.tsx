        ...
        <form onSubmit={handleSalvarPessoais} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex justify-center mb-2 md:col-span-2">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full bg-black/40 flex items-center justify-center opacity-70 sm:opacity-0 group-hover:opacity-100 transition-opacity">
